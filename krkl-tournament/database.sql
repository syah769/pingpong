...
CREATE TABLE IF NOT EXISTS matches (
    ...
    -- Individual game scores for best-of-5 format
    game1_team1 INT DEFAULT 0,
    game1_team2 INT DEFAULT 0,
    game2_team1 INT DEFAULT 0,
    game2_team2 INT DEFAULT 0,
    game3_team1 INT DEFAULT 0,
    game3_team2 INT DEFAULT 0,
    game4_team1 INT DEFAULT 0,
    game4_team2 INT DEFAULT 0,
    game5_team1 INT DEFAULT 0,
    game5_team2 INT DEFAULT 0,
    -- Track current game being played
